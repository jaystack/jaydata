$(document).ready(function () {
    ...
    //ModelBinderTests({ name: "oData", databaseName: 'T1', oDataServiceHost: "emptyNewsReader.svc", serviceUrl: 'newsDB', dbCreation: $data.storageProviders.sqLite.DbCreationType.DropAllExistingTables }, '_oData');
