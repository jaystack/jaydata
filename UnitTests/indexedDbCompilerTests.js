$(document).ready(function () {
    ...
    $data.NewsReaderContext = new $news.Types.NewsContext({ databaseName: "sqLiteCompilerTestDb", name: "indexedDb", dbCreation: $data.storageProviders.DbCreationType.DropAllExistingTables });
    $data.NewsReaderContext.onReady(function () {
        ...
        test("Simple: 1", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName != "loginName" }, null);
            var r = q.toTraceString();
            ok(true);
        });

         test("Simple: 2", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName || "loginName" }, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 3", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" && m.Id != 5 }, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 4", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" && m.Id != 5 || m.Id > 5}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 5", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" || m.Id != 5 && m.Id > 5}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 6", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" && m.Id != 5 || m.LoginName > "loginName" && m.Id < 5}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 7", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" || m.Id != 5 && m.LoginName > "loginName" || m.Id < 5}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 8", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" || m.Id != 5 && m.LoginName > "loginName" || m.Id < 5 && m.LoginName >= 'lName'}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 9", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return (m.LoginName == "loginName" || m.Id != 5) && (m.LoginName > "loginName" || m.Id < 5)}, null);
            var r = q.toTraceString();
            ok(true);
        });

        test("Simple: 10", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return m.LoginName == "loginName" && m.Id != 5 && m.LoginName > "loginName" || m.Id < 5}, null);
            var r = q.toTraceString();
            ok(true);
        });
         test("Simple: 11", 1, function () {
            var q = $data.NewsReaderContext.Users.where(function (m) { return (m.LoginName == "loginName" || m.Id != 5) && (m.LoginName > "loginName" || m.Id < 5 && m.LoginName <= "l2")}, null);
            var r = q.toTraceString();
            ok(true);
        });
